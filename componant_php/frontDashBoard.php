<?php
 ...
 <div class="compte"><h3>Information du compte</h3>
    ...
    <div class="agenda"><h3 class="planning">Agenda</h3>
        <div class="rdv">
    ...
    <div class="commentaire"><h3 class="clients">Derniers commentaires des clients</h3>
    ...
    <div class="mail"><h3 class="derniersMails">Derniers mails</h3>
